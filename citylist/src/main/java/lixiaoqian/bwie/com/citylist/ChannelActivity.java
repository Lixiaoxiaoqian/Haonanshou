package lixiaoqian.bwie.com.citylist;
...
public class ChannelActivity extends AppCompatActivity implements OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    public void initView() {
        ...
        mUserGv.setOnItemLongClickListener(this);
    }
    ...
    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
        mUserGv.setBackgroundColor(Color.YELLOW);
        return true;
    }
}
